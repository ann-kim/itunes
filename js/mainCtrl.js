...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  //Check tfhat the above method is working by entering a name into the input field on your web app, and then console.log the result

    //code here
  $scope.getSongData = function() {
    itunesService.getSong($scope.artist).then(function(res) {
      console.log(res);
      $scope.songData = res; //"Magic" is that res will be the infoToDisplay array in the service
    }, function(err) {
      console.log(err);
    })
  }
